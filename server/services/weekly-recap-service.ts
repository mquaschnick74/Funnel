...
export class WeeklyRecapService {
  ...
  private generateEmailHTML(firstName: string, daysSinceLastSession: number): string {
    ...
    if (isRecentUser) {
      mainMessage = `
        <p style="margin: 0 0 16px 0; color: #FFFFFF; font-size: 16px; line-height: 1.7;">
              ...
              <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%; background-color: #5B21B6; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(107, 70, 193, 0.12);">
                ...
                <tr>
                  <td align="center" style="padding: 0 40px 24px 40px;">
                    <h1 style="margin: 0; color: #F5F3FF; font-size: 28px; font-weight: 700; line-height: 1.3;">
                ...
                <tr>
                  <td style="padding: 0 40px 24px 40px;">
                    <p style="margin: 0 0 16px 0; color: #F5F3FF; font-size: 18px; font-weight: 600;">
                      Hello ${firstName},
                    </p>
                    ${mainMessage}
                  </td>
